...
public class ResourceControler {
	...
	public Map getResourcesByPage(@Param(value = "pageSize") Integer page,
		...
		List<Resource> resources = resourceService.findByPage(simplepage,
				params, orderBy);
	...
	public Integer deleteResource(@ModelAttribute Resource resource) {
		logger.info("Start to delete resource,resourceUrl="
	...
	public Integer addResource(@ModelAttribute Resource resource) {
		logger.info("Start to add new resource,resourceUrl="
				+ resource.getResourceUrl());
	 ...
	 * @return
	 */
	private Map<String, List<Map<String, String>>> trimPrivileges(
			List<Resource> privileges) {
	...
	public List<Map<String, Object>> getPrivilegeNodes() {
		...
		for (Map.Entry<String, List<Map<String, String>>> privilege : privileges
				.entrySet()) {
