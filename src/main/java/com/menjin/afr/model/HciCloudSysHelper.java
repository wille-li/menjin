...
public class HciCloudSysHelper {
	...
	String sPath = HciCloudAfrHelper.SYS_PATH;
    
    static {
		// 灵云sdk中dll文件目录
		String libPath = HciCloudAfrHelper.SYS_PATH + "\\libs";
		// 指定dll文件路径，顺序表示加载顺序
    ...
    private InitParam getInitParam() {
        ...
        initparam.addParam(InitParam.LogParam.PARAM_KEY_LOG_FILE_COUNT, "1");

        // 日志大小，默认一个日志文件写多大，单位为K
        initparam.addParam(InitParam.LogParam.PARAM_KEY_LOG_FILE_SIZE, "1024000");

        // 日志等级，0=无，1=错误，2=警告，3=信息，4=细节，5=调试，SDK将输出小于等于logLevel的日志信息
        initparam.addParam(InitParam.LogParam.PARAM_KEY_LOG_LEVEL, "0");
